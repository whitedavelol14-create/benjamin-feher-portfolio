...
import { createTPlatePlugin as createTPlatePlugin2 } from "@udecode/plate/react";
...
import { isHotkey, PathApi as PathApi3 } from "@udecode/plate";
import {
...
import { getEditorPlugin as getEditorPlugin2, PathApi as PathApi2 } from "@udecode/plate";
        ...
        editor.tf.withoutNormalizing(() => {
          ...
          if (entry) {
            if (editor.children.length === 0) {
              ...
              const prevPath = isHotkey("backspace")(e) ? PathApi3.previous(entry[1]) : entry[1];
              if (prevPath) {
