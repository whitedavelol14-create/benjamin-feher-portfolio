...
var DOMPlugin = createTSlatePlugin({
  ...
  withScrolling: (0, import_utils4.bindFirst)(withScrolling, editor)
        ...
        if (validAttribute) {
          if (typeof validAttribute === "string") {
            ...
            for (const [attributeName, attributeValue] of Object.entries(
              ...
              if (!(0, import_utils5.isDefined)(elAttribute) || !attributeValues.includes(elAttribute))
                return false;
            }
          }
        }
...
var htmlElementToLeaf = (editor, element) => {
  ...
  return deserializeHtmlNodeChildren(editor, element).reduce(
    (arr, child) => {
      if (!child) return arr;
      if (import_slate6.ElementApi.isElement(child)) {
        if (Object.keys(node).length > 0) {
          mergeDeepToNodes({
            node: child,
            query: {
              filter: ([n]) => import_slate6.TextApi.isText(n)
            },
            source: node
          });
        }
        ...
        if (import_slate6.TextApi.isText(child) && child.text) {
...
var HtmlPlugin = createSlatePlugin({
  ...
  deserialize: (0, import_utils7.bindFirst)(deserializeHtml, editor)
})).extend({
  parser: {
    format: "text/html",
...
// src/lib/utils/normalizeDescendantsToDocumentFragment.ts
var isInlineNode = (editor) => (node) => import_slate7.TextApi.isText(node) || import_slate7.ElementApi.isElement(node) && editor.api.isInline(node);
...
var normalize = (descendants, isInline, makeDefaultBlock) => {
  ...
  descendants = descendants.map((node) => {
    if (import_slate7.ElementApi.isElement(node)) {
      return {
        ...node,
        children: normalize(
          node.children,
...
var withSlate = (e, {
  ...
  const editor = e;
  editor.id = id ?? editor.id ?? (0, import_nanoid.nanoid)();
  editor.key = editor.key ?? (0, import_nanoid.nanoid)();
...
var SlateReactExtensionPlugin = toPlatePlugin(SlateExtensionPlugin, {
  ...
  transforms: {
    normalizeNode(entry, options) {
      if ((0, import_utils10.isDefined)(entry[0]._memo)) {
...
var createPlateEditor = ({
  editor = (0, import_slate9.createEditor)(),
  ...options
} = {}) => {
...
var PlateElement = import_react2.default.forwardRef(function PlateElement2({ as: Tag = "div", children, ...props }, ref) {
  ...
  const belowRootComponents = import_react2.default.useMemo(
  ...
  return /* @__PURE__ */ import_react2.default.createElement(
    ...
    children,
    belowRootComponents?.map((Component, index) => /* @__PURE__ */ import_react2.default.createElement(Component, { key: index, ...props }))
  );
});
...
var PlateLeaf = import_react2.default.forwardRef(({ as: Tag = "span", children, ...props }, ref) => {
  const attributes = useNodeAttributes(props, ref);
  return /* @__PURE__ */ import_react2.default.createElement(Tag, { ...attributes }, children);
});
...
var pluginRenderLeaf = (editor, plugin) => function render(props) {
  ...
  if (leaf[plugin.node.type ?? plugin.key]) {
    ...
    return /* @__PURE__ */ import_react3.default.createElement(Leaf, { ...ctxProps }, children);
  }
  return children;
};
...
var pluginRenderText = (editor, plugin) => function render(nodeProps) {
  ...
  if (text[plugin.node.type ?? plugin.key]) {
    ...
    return /* @__PURE__ */ import_react5.default.createElement(Text, { ...ctxProps }, children);
  }
  return children;
};
...
var useEditableProps = ({
  ...
  const storeReadOnly = (0, import_jotai_x2.useAtomStoreValue)(store, "readOnly");
...
var useNodePath = (node) => {
  ...
  return (0, import_react_utils2.useMemoizedSelector)(
    ...
    [editor, node],
    (a, b) => {
      return !!a && !!b && import_slate10.PathApi.equals(a, b);
    }
  );
};
...
function ElementContent({ editor, plugin, ...props }) {
  ...
  let component = /* @__PURE__ */ import_react9.default.createElement(Element, { ...props }, children);
...
var pluginRenderElement = (editor, plugin) => function render(props) {
  ...
  if (element.type === plugin.node.type) {
    return /* @__PURE__ */ import_react9.default.createElement(
      ...
      /* @__PURE__ */ import_react9.default.createElement(ElementContent, { editor, plugin, ...props })
    );
  }
};
...
var pipeRenderElement = (editor, renderElementProp) => {
  ...
  return function render(props) {
    ...
    return /* @__PURE__ */ import_react10.default.createElement(
      ...
      /* @__PURE__ */ import_react10.default.createElement(PlateElement, { ...ctxProps }, props.children)
    );
  };
};
...
var usePlateControllerStore = (idProp) => {
  const storeAtom = import_react11.default.useMemo(
...
var usePlateStore = (id) => {
  ...
  const [localStoreExists] = import_react12.default.useState(!!localStore.store);
  ...
  const fallbackStore = (0, import_react12.useMemo)(createPlateStore, []).usePlateStore();
  if (!store) {
...
var usePlateSet = (key, options) => {
  ...
  return (0, import_jotai_x4.useAtomStoreSet)(store, key);
};
var usePlateValue = (key, options) => {
  const store = usePlateStore(
    typeof options === "string" ? options : options?.scope
  );
  return (0, import_jotai_x4.useAtomStoreValue)(store, key);
};
var usePlateState = (key, options) => {
  const store = usePlateStore(
    typeof options === "string" ? options : options?.scope
  );
  return (0, import_jotai_x4.useAtomStoreState)(store, key);
};
var useEditorId = () => (0, import_jotai_x4.useAtomStoreValue)(usePlateStore(), "editor").id;
var useEditorContainerRef = (id) => {
  return (0, import_jotai_x4.useAtomStoreValue)(usePlateStore(id), "containerRef");
};
var useEditorScrollRef = (id) => {
  return (0, import_jotai_x4.useAtomStoreValue)(usePlateStore(id), "scrollRef");
};
var useScrollRef = (id) => {
...
var useEditorMounted = (id) => {
  return !!(0, import_jotai_x4.useAtomStoreValue)(usePlateStore(id), "isMounted");
};
var useEditorReadOnly = (id) => {
  return !!(0, import_jotai_x4.useAtomStoreValue)(usePlateStore(id), "readOnly");
};
var useEditorRef = (id) => {
  const store = usePlateStore(id);
  const editor = (0, import_jotai_x4.useAtomStoreValue)(store, "editor") ?? createPlateFallbackEditor();
  editor.store = store;
  return editor;
};
...
var useEditorVersion = (id) => {
  return (0, import_jotai_x4.useAtomStoreValue)(usePlateStore(id), "versionEditor");
};
var useSelectionVersion = (id) => {
  return (0, import_jotai_x4.useAtomStoreValue)(usePlateStore(id), "versionSelection");
};
var useEditorValue = (id) => usePlateStore(id).useTrackedValueValue().value;
var useValueVersion = (id) => {
  return (0, import_jotai_x4.useAtomStoreValue)(usePlateStore(id), "versionValue");
};
var useIncrementVersion = (key, id) => {
  const previousVersionRef = import_react12.default.useRef(1);
  const store = usePlateStore(id);
  const setVersionDecorate = (0, import_jotai_x4.useAtomStoreSet)(store, "versionDecorate");
  const setVersionSelection = (0, import_jotai_x4.useAtomStoreSet)(store, "versionSelection");
  const setVersionValue = (0, import_jotai_x4.useAtomStoreSet)(store, "versionValue");
  const setVersionEditor = (0, import_jotai_x4.useAtomStoreSet)(store, "versionEditor");
...
var useEditorSelector = (selector, deps, { id, equalityFn = (a, b) => a === b } = {}) => {
  const selectorAtom = import_react14.default.useMemo(
  ...
  return (0, import_jotai_x5.useStoreAtomValue)(usePlateStore(id), selectorAtom);
};
...
var useElement = (pluginKey = SCOPE_ELEMENT) => {
  const editor = useEditorRef();
  const value = (0, import_jotai_x6.useAtomStoreValue)(useElementStore(pluginKey), "element");
  if (!value) {
    editor.api.debug.warn(
...
var useElementSelector = (selector, deps, {
  ...
  return (0, import_jotai_x7.useStoreAtomValue)(useElementStore(key), selectorAtom);
};
...
var usePath = (pluginKey) => {
  const editor = useEditorRef();
  const value = (0, import_jotai_x8.useAtomStoreValue)(useElementStore(pluginKey), "path");
  if (!value) {
    editor.api.debug.warn(
...
function EditorHotkeysEffect({
  ...
  const editor = useEditorRef(id);
  return /* @__PURE__ */ import_react16.default.createElement(import_react16.default.Fragment, null, Object.entries(editor.shortcuts).map(([hotkeyString, hotkeyConfig]) => {
    if (!hotkeyConfig || !(0, import_utils14.isDefined)(hotkeyConfig.keys) || !hotkeyConfig.handler) {
      return null;
    }
...
function EditorRefEffect({ id }) {
  ...
  return /* @__PURE__ */ import_react18.default.createElement(import_react18.default.Fragment, null, editor.pluginList.map((plugin) => /* @__PURE__ */ import_react18.default.createElement(EditorRefPluginEffect, { id, key: plugin.key, plugin })));
}

// src/react/components/EditorStateEffect.tsx
var import_react19 = __toESM(require("react"));
var EditorStateEffect = import_react19.default.memo(() => {
  return null;
});
...
var PlateContainer = ({
  ...
  const mainContainer = /* @__PURE__ */ import_react22.default.createElement("div", { id: editor.uid, ref: containerRef, ...props }, children);
  editor.pluginList.forEach((plugin) => {
    const {
      render: {
...
function PlateSlate({
  ...
  editor.pluginList?.forEach((plugin) => {
    ...
    if (AboveSlate) aboveSlate = /* @__PURE__ */ import_react24.default.createElement(AboveSlate, null, aboveSlate);
  });
  return aboveSlate;
}
...
var PlateContent = import_react25.default.forwardRef(
  ({ autoFocusOnEditable, renderEditable, ...props }, ref) => {
    ...
    return /* @__PURE__ */ import_react25.default.createElement(PlateSlate, { id }, beforeEditable, aboveEditable, afterEditable);
  }
);
