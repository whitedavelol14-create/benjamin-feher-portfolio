...
var SlateElement = import_react.default.forwardRef(function SlateElement2({ as: Tag = "div", children, ...props }, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    children,
    belowRootComponents?.map((Component, index) => /* @__PURE__ */ import_react.default.createElement(Component, { key: index, ...props }))
  );
});
...
var SlateLeaf = import_react.default.forwardRef(({ as: Tag = "span", children, ...props }, ref) => {
  const attributes = useNodeAttributes(props, ref);
  return /* @__PURE__ */ import_react.default.createElement(Tag, { ...attributes }, children);
});
...
var pipeRenderElementStatic = (editor, {
  ...
  return function render(props) {
    ...
    return /* @__PURE__ */ import_react4.default.createElement(SlateElement, { ...ctxProps }, props.children);
  };
};
...
function BaseElementStatic({
  ...
  let children = /* @__PURE__ */ import_react6.default.createElement(
    Children,
    {
      components,
      decorate,
...
function BaseLeafStatic({
  ...
  const decoratedLeaves = import_slate6.TextApi.decorations(text, decorations);
...
var LeafStatic = import_react6.default.memo(BaseLeafStatic, (prev, next) => {
  return (
    // prev.text === next.text &&
    import_slate6.TextApi.equals(next.text, prev.text) && (0, import_slate6.isTextDecorationsEqual)(next.decorations, prev.decorations)
  );
});
var defaultDecorate = () => [];
function Children({
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, children.map((child, i) => {
    ...
    return import_slate6.ElementApi.isElement(child) ? /* @__PURE__ */ import_react6.default.createElement(
      ElementStatic,
      {
        key: i,
        components,
...
var pluginRenderLeafStatic = (editor, plugin, components) => function render(props) {
  ...
  if (leaf[plugin.node.type ?? plugin.key]) {
    ...
    return /* @__PURE__ */ import_react7.default.createElement(Leaf, { ...ctxProps }, children);
  }
  return children;
};
...
var createHotkey = (key) => {
  ...
  return (event) => {
    ...
    if (import_utils7.IS_APPLE && isApple?.(event)) return true;
    if (!import_utils7.IS_APPLE && isWindows?.(event)) return true;
    return false;
  };
};
...
var DOMPlugin = createTSlatePlugin({
  ...
  withScrolling: (0, import_utils8.bindFirst)(withScrolling, editor)
      ...
      ({ validAttribute, validClassName, validNodeName = "*", validStyle }) => {
        ...
        if (validStyle) {
          for (const [key, value] of Object.entries(validStyle)) {
            const values = (0, import_castArray2.default)(value);
        ...
        if (validAttribute) {
          if (typeof validAttribute === "string") {
            ...
            for (const [attributeName, attributeValue] of Object.entries(
              ...
              if (!(0, import_utils9.isDefined)(elAttribute) || !attributeValues.includes(elAttribute))
                return false;
            }
          }
        }
...
var htmlElementToLeaf = (editor, element) => {
  ...
  return deserializeHtmlNodeChildren(editor, element).reduce(
    (arr, child) => {
      if (!child) return arr;
      if (import_slate7.ElementApi.isElement(child)) {
        if (Object.keys(node).length > 0) {
          mergeDeepToNodes({
            node: child,
            query: {
              filter: ([n]) => import_slate7.TextApi.isText(n)
            },
            source: node
          });
        }
        ...
        if (import_slate7.TextApi.isText(child) && child.text) {
...
var HtmlPlugin = createSlatePlugin({
  ...
  deserialize: (0, import_utils11.bindFirst)(deserializeHtml, editor)
})).extend({
  parser: {
    format: "text/html",
...
// src/lib/utils/normalizeDescendantsToDocumentFragment.ts
var isInlineNode = (editor) => (node) => import_slate8.TextApi.isText(node) || import_slate8.ElementApi.isElement(node) && editor.api.isInline(node);
...
var normalize = (descendants, isInline, makeDefaultBlock) => {
  ...
  descendants = descendants.map((node) => {
    if (import_slate8.ElementApi.isElement(node)) {
      return {
        ...node,
        children: normalize(
          node.children,
