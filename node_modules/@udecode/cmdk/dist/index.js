...
__export(index_exports, {
  ...
  useCommandActions: () => useCommandActions,
  useCommandState: () => useCmdk
});
...
var Command = React.forwardRef(
  (props, forwardedRef) => {
    ...
    const listId = (0, import_react_id.useId)();
    const labelId = (0, import_react_id.useId)();
    const inputId = (0, import_react_id.useId)();
...
var Group = React.forwardRef(
  (props, forwardedRef) => {
    ...
    const headingId = (0, import_react_id.useId)();
    const context = useCommand();
    const render = useCmdk(
...
function useCmdk(selector) {
  ...
  return (0, import_shim.useSyncExternalStore)(store.subscribe, cb, cb);
}
