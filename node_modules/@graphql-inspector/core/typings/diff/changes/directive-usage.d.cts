...
export declare function directiveUsageFieldAddedFromMeta(args: DirectiveUsageFieldAddedChange): {
    readonly criticality: {
        readonly level: CriticalityLevel;
        readonly reason: `Directive '${string}' was added to field '${string}'`;
    };
    readonly type: "DIRECTIVE_USAGE_FIELD_ADDED";
    readonly message: string;
    readonly path: string;
    readonly meta: {
        typeName: string;
...
export declare function directiveUsageFieldRemovedFromMeta(args: DirectiveUsageFieldRemovedChange): {
    readonly criticality: {
        readonly level: CriticalityLevel;
        readonly reason: `Directive '${string}' was removed from field '${string}'`;
    };
    readonly type: "DIRECTIVE_USAGE_FIELD_REMOVED";
    readonly message: string;
    readonly path: string;
    readonly meta: {
        typeName: string;
