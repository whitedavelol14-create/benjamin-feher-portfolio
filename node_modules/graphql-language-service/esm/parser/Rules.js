...
export const ExperimentalFragmentArgumentParseRules = Object.assign(Object.assign({}, ParseRules), { FragmentArguments: [p('('), list('FragmentArgument'), p(')')], FragmentArgument: [name('attribute'), p(':'), 'Value'], FragmentSpread: [
        p('...'),
        name('def'),
