...
function onlineParser(options = {}) {
    const parserOptions = Object.assign({ eatWhitespace: stream => stream.eatWhile(Rules_1.isIgnored), lexRules: Rules_1.LexRules, parseRules: options.experimentalFragmentArguments
            ? Rules_1.ExperimentalFragmentArgumentParseRules
            : Rules_1.ParseRules, editorConfig: {} }, options);
    return {
        startState() {
            const initialState = {
                level: 0,
            ...
            pushRule(parserOptions.parseRules, initialState, graphql_1.Kind.DOCUMENT);
            return initialState;
        },
        token(stream, state) {
