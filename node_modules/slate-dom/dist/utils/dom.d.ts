 ...
 */
export declare const closestShadowAware: (element: DOMElement | null | undefined, selector: string) => DOMElement | null;
/**
 * Shadow DOM-aware version of Node.contains()
 * Checks if a node contains another node, crossing shadow DOM boundaries
 */
export declare const containsShadowAware: (parent: DOMNode | null | undefined, child: DOMNode | null | undefined) => boolean;
