...
export declare const TableCellElement: React.ForwardRefExoticComponent<Omit<Omit<import("@udecode/plate/react").PlateElementProps<import("@udecode/plate").TElement, import("@udecode/plate").AnyPluginConfig>, keyof {
    className?: string;
...
export declare const TableCellHeaderElement: React.ForwardRefExoticComponent<Omit<Omit<Omit<import("@udecode/plate/react").PlateElementProps<import("@udecode/plate").TElement, import("@udecode/plate").AnyPluginConfig>, keyof {
    className?: string;
    style?: React.CSSProperties;
}> & import("@udecode/plate").BasePluginContext<import("@udecode/plate").AnyPluginConfig> & {
    editor: import("@udecode/plate/react").PlateEditor;
