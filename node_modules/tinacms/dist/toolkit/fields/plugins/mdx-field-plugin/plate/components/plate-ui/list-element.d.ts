...
export declare const ListElement: React.ForwardRefExoticComponent<Omit<Omit<Omit<Omit<import("@udecode/plate/react").PlateElementProps<import("@udecode/plate").TElement, import("@udecode/plate").AnyPluginConfig>, keyof {
    className?: string;
    ...
    variant?: "ol" | "ul";
} & import("class-variance-authority/types").ClassProp) => string>, "ref"> & React.RefAttributes<unknown>, "ref"> & React.RefAttributes<unknown>>;
