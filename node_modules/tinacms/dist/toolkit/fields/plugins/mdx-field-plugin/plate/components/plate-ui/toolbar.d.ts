...
declare const ToolbarButton: React.ForwardRefExoticComponent<{
    ...
    pressed?: boolean;
    showArrow?: boolean;
} & Omit<Omit<Omit<Omit<ToolbarPrimitive.ToolbarToggleItemProps & React.RefAttributes<HTMLButtonElement>, "ref"> & Omit<ToolbarPrimitive.ToolbarToggleItemProps & React.RefAttributes<HTMLButtonElement>, "size" | "variant"> & VariantProps<(props?: {
    size?: "default" | "sm" | "lg";
    variant?: "default" | "outline";
} & import("class-variance-authority/types").ClassProp) => string>, "ref"> & React.RefAttributes<HTMLButtonElement>, "ref">, "value" | "asChild"> & VariantProps<(props?: {
    size?: "default" | "sm" | "lg";
    variant?: "default" | "outline";
...
export declare const ToolbarToggleItem: React.ForwardRefExoticComponent<Omit<Omit<ToolbarPrimitive.ToolbarToggleItemProps & React.RefAttributes<HTMLButtonElement>, "ref"> & Omit<ToolbarPrimitive.ToolbarToggleItemProps & React.RefAttributes<HTMLButtonElement>, "size" | "variant"> & VariantProps<(props?: {
    size?: "default" | "sm" | "lg";
    variant?: "default" | "outline";
