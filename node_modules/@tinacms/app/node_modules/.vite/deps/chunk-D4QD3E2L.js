import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-HTLJE35O.js";
import {
  insertCluster
} from "./chunk-ZBG3KTNC.js";
import {
  insertNode
} from "./chunk-J6MB4MUY.js";
import {
  labelHelper
} from "./chunk-U2OEB7TT.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-GXQ25YYZ-J665SDSF.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-42K2YHIH-YXODSD4S.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-WCTI25Z6.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-D4QD3E2L.js.map
