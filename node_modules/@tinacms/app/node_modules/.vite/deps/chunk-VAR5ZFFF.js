...
var keysCache = /* @__PURE__ */ Object.create(null);
var keysRegex = /[.[\]]+/;
...
var isValidArrayIndex = function isValidArrayIndex2(key) {
  var num = Number(key);
...
function createForm(config) {
  ...
  var state = {
    ...
    fieldSubscribers: /* @__PURE__ */ Object.create(null),
  ...
  var renameField = function renameField2(state2, from, to) {
    if (state2.fields[from]) {
      ...
      state2.fields = Object.assign(/* @__PURE__ */ Object.create(null), state2.fields, (_Object$assign = {}, _Object$assign[to] = _extends({}, state2.fields[from], {
        name: to,
      ...
      state2.fieldSubscribers = Object.assign(/* @__PURE__ */ Object.create(null), state2.fieldSubscribers, (_Object$assign2 = {}, _Object$assign2[to] = state2.fieldSubscribers[from], _Object$assign2));
  ...
  var runFieldLevelValidation = function runFieldLevelValidation2(field, setError) {
    ...
    if (validators.length) {
      ...
      validators.forEach(function(validator) {
        var errorOrPromise = validator(getIn(state.formState.values, field.name), state.formState.values, validator.length === 0 || validator.length === 3 ? publishFieldState(state.formState, field) : void 0);
        if (errorOrPromise && isPromise(errorOrPromise)) {
          field.asyncValidationCount++;
          field.validating = true;
          var fieldInstanceId = field.instanceId;
  ...
  var runValidation = function runValidation2(fieldChanged, callback) {
    ...
    var promise = Promise.all(promises).then(clearAsyncValidationPromise(asyncValidationPromiseKey))["catch"](function(error) {
      clearAsyncValidationPromise(asyncValidationPromiseKey)(void 0);
      throw error;
    });
      ...
      var forEachError = function forEachError2(fn) {
        fieldKeys.forEach(function(name) {
          if (fields[name]) {
            ...
            var asyncRecordLevelError = afterAsync ? getIn(asyncRecordLevelErrors, name) : void 0;
            var errorFromParent = getIn(merged, name);
            var hasFieldLevelValidation = getValidators(safeFields[name]).length;
            var fieldLevelError = fieldLevelErrors[name];
            fn(name, hasFieldLevelValidation && fieldLevelError || validate && (asyncRecordLevelError || recordLevelError) || (!recordLevelError && !limitedFieldLevelValidation ? errorFromParent : void 0));
          }
        });
      };
  ...
  var calculateNextFormState = function calculateNextFormState2() {
    ...
    var dirtyFields = safeFieldKeys.reduce(function(result, key2) {
      var dirty = !safeFields[key2].isEqual(getIn(formState.values, key2), getIn(formState.initialValues || {}, key2));
      if (dirty) {
        foundDirty = true;
        result[key2] = true;
      }
    ...
    var dirtyFieldsSinceLastSubmit = safeFieldKeys.reduce(function(result, key2) {
      var nonNullLastSubmittedValues = formState.lastSubmittedValues || {};
      if (!safeFields[key2].isEqual(getIn(formState.values, key2), getIn(nonNullLastSubmittedValues, key2))) {
        result[key2] = true;
      }
      return result;
    }, {});
    ...
    var _safeFieldKeys$reduce = safeFieldKeys.reduce(function(result, key2) {
      result.modified[key2] = safeFields[key2].modified;
      result.touched[key2] = safeFields[key2].touched;
      result.visited[key2] = safeFields[key2].visited;
      return result;
    }, {
      modified: {},
      touched: {},
  ...
  var api = {
    ...
    registerField: function registerField(name, subscriber, subscription, fieldConfig) {
      ...
      if (fieldConfig) {
        ...
        var currentValue = getIn(state.formState.values, name);
        var currentInitialValue = getIn(state.formState.initialValues, name);
        if (fieldConfig.initialValue !== void 0 && (noValueInFormState || currentValue === currentInitialValue)) {
          ...
          fieldConfig.initialValue !== void 0 && fieldConfig.initialValue !== currentInitialValue && currentValue !== void 0
        ) {
          state.formState.initialValues = setIn(state.formState.initialValues || {}, name, fieldConfig.initialValue);
          runValidation(void 0, notify2);
        }
...
//# sourceMappingURL=chunk-VAR5ZFFF.js.map
