...
import { NormalizedOperationAvoidOptionalsConfig, type OperationAvoidOptionalsConfig } from './operation-avoid-optionals.cjs';
import { type NormalizedOperationDeclarationKindConfig, type OperationDeclarationKind, type OperationDeclarationKindConfig } from './operation-declaration-kinds.cjs';
import { SelectionSetToObject } from './selection-set-to-object.cjs';
import { CustomDirectivesConfig, NormalizedScalarsMap } from './types.cjs';
