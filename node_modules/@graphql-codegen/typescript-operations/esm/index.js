import { concatAST, parse, printIntrospectionSchema, } from 'graphql';
...
export const plugin = async (inputSchema, rawDocuments, config, { outputFile }) => {
    ...
    let introspectionTypesDefinitions = [];
...
const findTransformedDefinitions = (visitedResult) => {
