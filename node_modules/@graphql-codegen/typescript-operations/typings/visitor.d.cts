import { GraphQLEnumType, GraphQLInputObjectType, GraphQLScalarType, InputObjectTypeDefinitionNode, InputValueDefinitionNode, type DocumentNode, type EnumTypeDefinitionNode, type GraphQLSchema, type TypeDefinitionNode } from 'graphql';
...
import type { TypeScriptDocumentsPluginConfig } from './config.cjs';
...
export declare class TypeScriptDocumentsVisitor extends BaseDocumentsVisitor<TypeScriptDocumentsPluginConfig, TypeScriptDocumentsParsedConfig> {
     ...
     */
    protected _usedEnumIntrospectionType: boolean;
    private _outputPath;
