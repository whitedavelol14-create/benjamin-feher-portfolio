...
const getTypeInfo_1 = __importDefault(require("./utils/getTypeInfo"));
const SchemaReference_1 = require("./utils/SchemaReference");
require("./utils/info-addon");
codemirror_1.default.registerHelper('info', 'graphql', (token, options) => {
    var _a;
    if (!options.schema || !token.state) {
        return;
    }
    const { kind, step } = token.state;
    const typeInfo = (0, getTypeInfo_1.default)(options.schema, token.state);
