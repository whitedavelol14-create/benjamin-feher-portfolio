...
export declare abstract class PostHogBackendClient extends PostHogCoreStateless implements IPostHog {
    ...
    protected enqueue(type: string, message: any, options?: PostHogCaptureOptions, explicitRoute?: string): void;
    flush(): Promise<void>;
    ...
    private sendAiCaptureBatch;
    private sendAiSubBatch;
    private getV1Sender;
    /**
