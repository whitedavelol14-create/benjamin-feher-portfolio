...
var __webpack_modules__ = {
    ...
    "../gzip.node": function(module) {
        module.exports = require("../gzip.node.js");
    },
...
(()=>{
    ...
    var _gzip_node__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("../gzip.node");
    class PostHog extends _client__WEBPACK_IMPORTED_MODULE_4__.PostHogBackendClient {
        getLibraryId() {
            return 'posthog-node';
        }
        compressPayload(payload) {
            return (0, _gzip_node__WEBPACK_IMPORTED_MODULE_7__.gzipCompress)(payload, this.isDebug);
        }
        initializeContext() {
