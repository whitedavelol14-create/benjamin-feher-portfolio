 ...
 */
export declare function isArrayFieldName(fieldName: string, name: string): boolean;
/**
 ...
 */
export declare function getArrayFieldIndex(fieldName: string, name: string): number;
//#endregion
