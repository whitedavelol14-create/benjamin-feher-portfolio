 ...
 * ```
 */
export declare const useFormLabel: import("@ariakit/react-utils").Hook<"label", FormLabelOptions<"label">>;
/**
 ...
 * ```
 */
export declare const FormLabel: (props: FormLabelProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;
