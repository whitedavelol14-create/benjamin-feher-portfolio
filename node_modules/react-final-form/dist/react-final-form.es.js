...
import { formSubscriptionItems, createForm, version as version$1, fieldSubscriptionItems, getIn } from 'final-form';
...
function renderComponent(props, lazyProps, name) {
  ...
  if (component) {
    ...
    return /*#__PURE__*/React.createElement(component, _result);
  }
  if (render) {
    var _result2 = {};
...
function useFormState(_temp) {
  ...
  var firstSubscriptionRef = React.useRef(true);
  var pendingOnChangeRef = React.useRef(null);
  var lastOnChangeRef = React.useRef(null);
  React.useEffect(function () {
...
function useField(name, config) {
  ...
  var prevInitialValueRef = React.useRef(initialValue);
  React.useEffect(function () {
    ...
    if (!isEqual(prevInitialValue, initialValue) && initialValue !== undefined) {
      ...
      var formState = form.getState();
      var currentFormInitial = formState.initialValues ? getIn(formState.initialValues, name) : undefined;

      // Only update if the new initialValue differs from current form initial
      if (!isEqual(initialValue, currentFormInitial)) {
        var currentValue = formState.values ? getIn(formState.values, name) : undefined;
  ...
  var getInputValue = function getInputValue() {
    ...
    var value = state.name !== name ? getIn((_form$getState$values = form.getState().values) != null ? _form$getState$values : {}, name) : state.value;
  ...
  var getInputChecked = function getInputChecked() {
    ...
    var value = state.name !== name ? getIn((_form$getState$values2 = form.getState().values) != null ? _form$getState$values2 : {}, name) : state.value;
    if (type === "checkbox") {
