...
declare class PostHogPersistence {
    ...
    private _storesIdentityInCookie;
    ...
    private _pendingCrossTabFeatureFlagChanges;
    private _storageMigrationInProgress;
    private _localIdentityChangePending;
    private _crossTabFeatureFlagIdentityMismatch;
    private _facebookClickIdChangePending;
    private readonly _crossTabFeatureFlagHandlers;
    private _onStorage?;
    /**
    ...
    destroy(): void;
    private _syncCrossTabFeatureFlagProperties;
    private _hasCrossTabFeatureFlagIdentityMismatch;
    private _rememberCrossTabStorageFingerprint;
    private _mergeCrossTabFeatureFlagProperties;
    private _reconcileCrossTabFeatureFlagPropertiesBeforeWrite;
    private _setCrossTabFeatureFlagChangesPending;
    private _markAllCrossTabFeatureFlagChangesPending;
    private _markLoadedCrossTabFeatureFlagChangesPending;
    private _mergePendingCrossTabFeatureFlagChanges;
    private _markPendingCrossTabFeatureFlagChanges;
    ...
    private _truncateExistingPersonInfoForCookie;
