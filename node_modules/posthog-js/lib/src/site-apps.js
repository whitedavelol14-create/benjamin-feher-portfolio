...
var SiteApps = /** @class */ (function () {
    ...
    Object.defineProperty(SiteApps.prototype, "siteAppLoaders", {
        get: function () {
            var _a, _b;
            return (_b = (_a = globals_2.assignableWindow._POSTHOG_REMOTE_CONFIG) === null || _a === void 0 ? void 0 : _a[this._instance.config.token]) === null || _b === void 0 ? void 0 : _b.siteApps;
        },
        enumerable: false,
        configurable: true
    });
    ...
    SiteApps.prototype.onRemoteConfig = function (result) {
        var e_5, _a;
        var _this = this;
        var _b, _c, _d, _e, _f;
        ...
        var _loop_2 = function (id, url) {
            globals_2.assignableWindow["__$$ph_site_app_".concat(id)] = this_2._instance;
            (_f = (_e = globals_2.assignableWindow.__PosthogExtensions__) === null || _e === void 0 ? void 0 : _e.loadSiteApp) === null || _f === void 0 ? void 0 : _f.call(_e, this_2._instance, url, function (err) {
                if (err) {
