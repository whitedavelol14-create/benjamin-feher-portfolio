...
var ProductTourEventReceiver = /** @class */ (function (_super) {
    ...
    ProductTourEventReceiver.prototype._getActivatedSessionKey = function () {
        return constants_1.PRODUCT_TOURS_ACTIVATED_SESSION;
    };
    ...
    ProductTourEventReceiver.prototype._setActivatedSession = function (sessionId) {
        var _a;
        var _b, _c;
        (_c = (_b = this._instance) === null || _b === void 0 ? void 0 : _b.persistence) === null || _c === void 0 ? void 0 : _c.register((_a = {}, _a[constants_1.PRODUCT_TOURS_ACTIVATED_SESSION] = sessionId, _a));
    };
    ProductTourEventReceiver.prototype._clearActivatedSession = function () {
        var _a, _b;
        (_b = (_a = this._instance) === null || _a === void 0 ? void 0 : _a.persistence) === null || _b === void 0 ? void 0 : _b.unregister(constants_1.PRODUCT_TOURS_ACTIVATED_SESSION);
    };
