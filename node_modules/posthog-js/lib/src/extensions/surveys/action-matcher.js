...
var ActionMatcher = /** @class */ (function () {
    function ActionMatcher(_instance) {
        var _this = this;
    ...
    ActionMatcher.prototype.init = function () {
        ...
        if (!(0, core_1.isUndefined)((_a = this._instance) === null || _a === void 0 ? void 0 : _a._addCaptureHook)) {
            ...
            this._captureHookUnsubscribe = (_b = this._instance) === null || _b === void 0 ? void 0 : _b._addCaptureHook(matchEventToAction);
        }
    };
    ActionMatcher.prototype.dispose = function () {
        var _a;
        (_a = this._captureHookUnsubscribe) === null || _a === void 0 ? void 0 : _a.call(this);
    ...
    ActionMatcher.prototype.register = function (actions) {
        ...
        actions.forEach(function (action) {
            var _a;
            _this._actionRegistry.add(action);
            (_a = action.steps) === null || _a === void 0 ? void 0 : _a.forEach(function (step) {
                _this._actionEvents.add((step === null || step === void 0 ? void 0 : step.event) || '');
            });
        });
            ...
            this._actionRegistry.forEach(function (action) {
                ...
                (_a = action.steps) === null || _a === void 0 ? void 0 : _a.forEach(function (step) {
                    if (step === null || step === void 0 ? void 0 : step.selector) {
                        selectorsToWatch_1.add(step.selector);
                    }
                });
            });
            this._instance.autocapture.setElementSelectors(selectorsToWatch_1);
        }
    };
    ActionMatcher.prototype.replace = function (actions) {
