...
function QuestionHeader(_a) {
    ...
    var isHeaderEmpty = !question.question && !question.description;
    return ((0, jsx_runtime_1.jsxs)("div", { class: isHeaderEmpty ? 'question-header question-header--empty' : 'question-header', children: [(0, jsx_runtime_1.jsx)(TitleComponent, { className: "survey-question", htmlFor: htmlFor, children: question.question }), question.description &&
