...
function ProductTourTooltip(_a) {
    ...
    (0, hooks_1.useEffect)(function () {
        ...
        (0, general_utils_1.addEventListener)(window, 'scroll', handleUpdate, { capture: true });
        (0, general_utils_1.addEventListener)(window, 'resize', handleUpdate);
        return function () {
    ...
    (0, hooks_1.useEffect)(function () {
        ...
        (0, general_utils_1.addEventListener)(window, 'keydown', handleKeyDown);
        return function () {
