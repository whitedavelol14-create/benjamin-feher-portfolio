...
var PostHogConversations = /** @class */ (function () {
     ...
     */
    PostHogConversations.prototype.getUnavailableReason = function () {
        if (this.isAvailable()) {
            return null;
        }
        if (this._instance.config.disable_conversations) {
        ...
        if ((0, core_1.isNullish)(this._remoteConfig) || !this._remoteConfig.token) {
            return 'missing_token';
        }
        if (!(globals_1.assignableWindow === null || globals_1.assignableWindow === void 0 ? void 0 : globals_1.assignableWindow.__PosthogExtensions__)) {
