...
var constants_1 = require("@posthog/browser-common/constants");
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype._setToolbarState = function (state) {
        globals_2.assignableWindow['ph_toolbar_state'] = state;
    };
    Toolbar.prototype._getToolbarState = function () {
        var _a;
        return (_a = globals_2.assignableWindow['ph_toolbar_state']) !== null && _a !== void 0 ? _a : ToolbarState.UNINITIALIZED;
    };
    ...
    Toolbar.prototype.maybeLoadToolbar = function (location, localStorage, history) {
        ...
        if ((0, general_utils_1.isToolbarInstance)(this.instance.config)) {
            return false;
        }
        ...
        try {
            ...
            var state = stateHash_1
                ? (0, general_utils_1.trySafe)(function () { return JSON.parse(atob(decodeURIComponent(stateHash_1))); }) ||
                    (0, general_utils_1.trySafe)(function () { return JSON.parse(decodeURIComponent(stateHash_1)); })
                : null;
    ...
    Toolbar.prototype._callLoadToolbar = function (params) {
        var loadFn = globals_2.assignableWindow['ph_load_toolbar'] || globals_2.assignableWindow['ph_load_editor'];
    ...
    Toolbar.prototype.loadToolbar = function (params) {
        ...
        if (this._getToolbarState() === ToolbarState.LOADED) {
            ...
            (_b = (_a = globals_2.assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.loadExternalDependency) === null || _b === void 0 ? void 0 : _b.call(_a, this.instance, 'toolbar', function (err) {
                if (err) {
            ...
            (0, general_utils_1.addEventListener)(globals_1.window, 'turbolinks:load', function () {
                _this._setToolbarState(ToolbarState.UNINITIALIZED);
