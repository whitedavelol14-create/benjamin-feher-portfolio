...
var ConsentManager = /** @class */ (function () {
    ...
    Object.defineProperty(ConsentManager.prototype, "_storage", {
        get: function () {
            ...
            var preferredStore = persistenceType === 'localStorage' ? storage_1.localStore : storage_1.cookieStore;
            ...
            var expectedStore = preferredStore._is_supported() ? preferredStore : storage_1.memoryStore;
    ...
    ConsentManager.prototype._getDnt = function () {
        ...
        return [
            ...
            globals_1.navigator === null || globals_1.navigator === void 0 ? void 0 : globals_1.navigator.globalPrivacyControl,
