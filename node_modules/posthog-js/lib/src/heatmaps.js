...
var Heatmaps = /** @class */ (function () {
    ...
    Heatmaps.prototype.onRemoteConfig = function (result) {
        var _a;
        if (!result.ok) {
    ...
    Heatmaps.prototype._setupListeners = function () {
        ...
        (0, general_utils_1.addEventListener)(globals_1.window, constants_1.DOM_EVENT_BEFOREUNLOAD, this._flushHandler);
        ...
        (0, general_utils_1.addEventListener)(globals_1.document, 'click', this._onClickHandler, { capture: true });
        ...
        (0, general_utils_1.addEventListener)(globals_1.document, 'mousemove', this._onMouseMoveHandler, { capture: true });
        ...
        (0, general_utils_1.addEventListener)(globals_1.document, constants_1.DOM_EVENT_VISIBILITYCHANGE, this._onVisibilityChange_handler);
