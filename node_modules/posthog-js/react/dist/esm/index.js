...
function PostHogProvider(_b) {
    ...
    return React.createElement(PostHogContext.Provider, { value: {
            client: posthog,
...
function useFeatureFlagEnabled(flag, defaultValue) {
    var _b, _c;
    var _d = useContext(PostHogContext), client = _d.client, bootstrap = _d.bootstrap;
    var _e = useState(function () { return client.isFeatureEnabled(flag); }), featureEnabled = _e[0], setFeatureEnabled = _e[1];
    useEffect(function () {
...
function useFeatureFlagPayload(flag) {
    ...
    var _d = useState(function () { var _b; return (_b = client.getFeatureFlagResult(flag, { send_event: false })) === null || _b === void 0 ? void 0 : _b.payload; }), featureFlagPayload = _d[0], setFeatureFlagPayload = _d[1];
    useEffect(function () {
        return client.onFeatureFlags(function () {
            var _b;
...
function useFeatureFlagResult(flag) {
    var _b, _c;
    var _d = useContext(PostHogContext), client = _d.client, bootstrap = _d.bootstrap;
    var _e = useState(function () { return client.getFeatureFlagResult(flag); }), result = _e[0], setResult = _e[1];
    useEffect(function () {
        return client.onFeatureFlags(function () {
...
function useActiveFeatureFlags() {
    var _b;
    var _c = useContext(PostHogContext), client = _c.client, bootstrap = _c.bootstrap;
    var _d = useState(function () { return client.featureFlags.getFlags(); }), featureFlags = _d[0], setFeatureFlags = _d[1];
    useEffect(function () {
...
function useFeatureFlagVariantKey(flag) {
    var _b;
    var _c = useContext(PostHogContext), client = _c.client, bootstrap = _c.bootstrap;
    var _d = useState(function () { return client.getFeatureFlag(flag); }), featureFlagVariantKey = _d[0], setFeatureFlagVariantKey = _d[1];
    useEffect(function () {
        return client.onFeatureFlags(function () {
...
function VisibilityAndClickTracker(_b) {
    ...
    var ref = useRef(null);
    var observerOptions = useMemo(function () { return (__assign({ threshold: .1 }, options)); }, [
    ...
    return React.createElement("div", __assign(__assign({ ref: ref }, props), { onClick: onClick }), children);
}
...
function PostHogFeature(_b) {
    ...
    if (!isUndefined(variant)) {
        if (isUndefined(match) || variant === match) {
            ...
            return React.createElement(VisibilityAndClickTrackers, __assign({ flag: flag, options: visibilityObserverOptions, trackInteraction: shouldTrackInteraction, trackView: shouldTrackView, onInteract: function () { return captureFeatureInteraction({
                    flag: flag,
                    posthog: posthog,
                    flagVariant: variant
...
function TrackedChild(_b) {
    ...
    return React.createElement(VisibilityAndClickTracker, {
...
function PostHogCaptureOnViewed(_b) {
    ...
    if (trackAllChildren) {
        var trackedChildren = Children.map(children, function (child, index) {
            return React.createElement(TrackedChild, {
                key: index,
                child: child,
                index: index,
                name: name,
        ...
        return React.createElement("div", props, trackedChildren);
    }
